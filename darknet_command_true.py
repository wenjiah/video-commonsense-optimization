...
frame_dir = "../data/Youtube-8M_seg/video_label/yolo-9000-clip-select-split/test_true_frames"
test_dir = "../data/Youtube-8M_seg/video_label/yolo-9000-clip-select-split/test"
# video_dir = "../data/HowTo100M/video"
# frame_dir = "../data/HowTo100M/video_label/yolo-9000-clip-select-split/test_true_frames"
# test_dir = "../data/HowTo100M/video_label/yolo-9000-clip-select-split/test"
total_label_files = os.listdir(test_dir)

for label_file in total_label_files:
    ...
    df.to_csv("../data/Youtube-8M_seg/video_label/yolo-9000-clip-select-split/test_true/" + label_file, index=None)
    # df.to_csv("../data/HowTo100M/video_label/yolo-9000-clip-select-split/test_true/" + label_file, index=None)
