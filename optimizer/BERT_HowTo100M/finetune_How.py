...
import pickle
import time
from util_How import CustomDataset, ComputeMetric  
...
train_dataset = [] 
train_dir = "../../data/HowTo100M/video_label/yolo-9000-clip-select-split/train/"
...
finetune_videos = []
test_true_dataset = []
test_true_dir = "../../data/HowTo100M/video_label/yolo-9000-clip-select-split/test_true/"
video_interval = 2
label_count = 0
...
with open("../../model/finetune_videos_How.txt", 'wb') as f:
...
model = AutoModelForSequenceClassification.from_pretrained("../../model/train_How/checkpoint-6500")
training_args = TrainingArguments(output_dir="../../model/finetune_How", evaluation_strategy="steps", warmup_ratio=0.1, logging_steps=500, per_device_train_batch_size=64, per_device_eval_batch_size=512, num_train_epochs=4, learning_rate=2e-05, load_best_model_at_end = True, metric_for_best_model = 'avg processed videos', greater_is_better = False, save_total_limit=1)
